...
const NavLogo = () => <img className='h-12 w-12' src={logo} alt='MkaeLoop Logo' />;
...
export default function AppNavBar() {
  ...
  return (
    <header className='absolute inset-x-0 top-0 z-50 shadow sticky bg-primary bg-opacity-100 backdrop-blur-lg backdrop-filter dark:border dark:border-gray-100/10 dark:bg-boxdark-2'>
      <nav className='flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
        <div className='flex lg:flex-1'>
          <a href='/' className='-m-1.5 p-1.5'>
            <img className='h-12 w-12' src={logo} alt='MkaeLoop Logo' />
          </a>
        </div>
