...
export const getLoops: GetLoops<void, Loop[]> = async (_args, context) => {
...
export const getActiveLoops: GetActiveLoops<void, Loop[]> = async (_args, context) => {
  return context.entities.Loop.findMany({
    where: {
      isActive: true,
    },
...
export const getUsernameFromLoopID: GetUsernameFromLoopID<{ id: number }, string | null> = async ({ id }, context) => {
